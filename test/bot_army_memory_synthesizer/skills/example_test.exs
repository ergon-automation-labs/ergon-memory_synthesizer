defmodule BotArmyMemorySynthesizer.Skills.ExampleTest do
  @moduledoc """
  ...
  alias BotArmyMemorySynthesizer.Skills.Example
  ...
  describe "nats_triggers/0" do
    test "returns list of trigger subjects" do
      ...
      assert "bot.bot_army_memory_synthesizer.command.example" in triggers
    end
  end
