defmodule BotArmyMemorySynthesizer.PulsePublisher do
  @moduledoc """
  Periodic health publisher for Memory Synthesizer Bot.
  ...
  2. **`bot.memory_synthesizer.pulse`** — richer metrics every 30 minutes (lower NATS volume).
  ...
  @service_name "memory_synthesizer"
  @envelope_source "bot_army_memory_synthesizer"
  ...
  @impl true
  def init(_opts) do
    Logger.info("[PulsePublisher] Starting Memory Synthesizer Bot pulse publisher")
