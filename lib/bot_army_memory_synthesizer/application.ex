defmodule BotArmyMemorySynthesizer.Application do
  @moduledoc """
  Memory Synthesizer Bot application supervisor.
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: BotArmyMemorySynthesizer.Supervisor]
  ...
  defp maybe_add_repo(children) do
    if @env == :test do
      ...
      [{BotArmyMemorySynthesizer.Repo, []} | children]
    end
  end
  ...
  defp maybe_add_pulse_publisher(children) do
    if @env == :test do
      ...
      [{BotArmyMemorySynthesizer.PulsePublisher, []} | children]
    end
  end
