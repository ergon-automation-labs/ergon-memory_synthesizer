{application,grpcbox,
             [{description,"Erlang grpc library based on chatterbox"},
              ...
              {modules,[grpcbox,grpcbox_acceptor,grpcbox_app,
                        ...
                        grpcbox_metadata,grpcbox_name_resolver,grpcbox_pool,
                        grpcbox_reflection_bhvr,grpcbox_reflection_client,
                        grpcbox_reflection_pb,grpcbox_reflection_service,
                        grpcbox_services_simple_sup,grpcbox_services_sup,
                        grpcbox_socket,grpcbox_stream,grpcbox_subchannel,
                        grpcbox_sup,grpcbox_utils]},
              {licenses,["Apache-2.0"]},
